...
namespace AasxPackageExplorer
{
    ...
    public class DispEditHelperBasics
    {
        ...
        public void AddGetIdInfoFromEclass(Panel view, string key, string buttionText, String irdi)
        {
            if (buttionText == null)
                return;
        ...
        public void GetIdInfoFromEclass(String irdi)
        {
            if (this.flyoutProvider != null)
            {
                var uc = new ShowEclassInfoFlyout();
                uc.GetInfo(irdi);
                this.flyoutProvider.StartFlyoverModal(uc);
            }
        }
            ...
            ModifyRepo.LambdaAction takeOverLambdaAction = null)
        {
            ...
            if (keys != null)
            {
                ...
                repo.RegisterControl(
                    ...
                    {
                        string resIRDI = null;
                        if (this.ReserveIDAtEclass(ref resIRDI))
                        {
                            keys.Add(
                                AdminShell.Key.CreateNew(
                                    AdminShell.Key.GlobalReference, false,
